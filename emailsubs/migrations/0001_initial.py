...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('emailsubs_emailsent', (
            ('id', orm['emailsubs.EmailSent:id']),
            ('board', orm['emailsubs.EmailSent:board']),
            ('num_times_sent', orm['emailsubs.EmailSent:num_times_sent']),
            ('created_on', orm['emailsubs.EmailSent:created_on']),
            ('updated_on', orm['emailsubs.EmailSent:updated_on']),
        ))
        db.send_create_signal('emailsubs', ['EmailSent'])
        
        # Adding model 'EmailSubscription'
        db.create_table('emailsubs_emailsubscription', (
            ('id', orm['emailsubs.EmailSubscription:id']),
            ('board', orm['emailsubs.EmailSubscription:board']),
            ('email', orm['emailsubs.EmailSubscription:email']),
            ('send_jobs_email', orm['emailsubs.EmailSubscription:send_jobs_email']),
            ('is_confirmed', orm['emailsubs.EmailSubscription:is_confirmed']),
            ('key', orm['emailsubs.EmailSubscription:key']),
        ))
        db.send_create_signal('emailsubs', ['EmailSubscription'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('emailsubs_emailsent')
        
        # Deleting model 'EmailSubscription'
        db.delete_table('emailsubs_emailsubscription')
    ...
    models = {
        ...
        'emailsubs.emailsubscription': {
            ...
            'send_jobs_email': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
        'zobpress.board': {
