...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EmailSubscription.send_jobs_email'
        db.delete_column('emailsubs_emailsubscription', 'send_jobs_email')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'EmailSubscription.send_jobs_email'
        db.add_column('emailsubs_emailsubscription', 'send_jobs_email', orm['emailsubs.emailsubscription:send_jobs_email'])
