...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobType.count'
        db.add_column('zobpress_jobtype', 'count', orm['zobpress.jobtype:count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'JobType.count'
        db.delete_column('zobpress_jobtype', 'count')
