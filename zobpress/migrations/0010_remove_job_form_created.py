...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobFormModel.created'
        db.add_column('zobpress_jobformmodel', 'created', orm['zobpress.jobformmodel:created'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'JobFormModel.created'
        db.delete_column('zobpress_jobformmodel', 'created')
