...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.job_slug'
        db.add_column('zobpress_job', 'job_slug', orm['zobpress.job:job_slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Job.job_slug'
        db.delete_column('zobpress_job', 'job_slug')
