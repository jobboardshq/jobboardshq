...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applicant.email'
        db.add_column('zobpress_applicant', 'email', orm['zobpress.applicant:email'])
        
        # Adding field 'Applicant.job'
        db.add_column('zobpress_applicant', 'job', orm['zobpress.applicant:job'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Applicant.email'
        db.delete_column('zobpress_applicant', 'email')
        
        # Deleting field 'Applicant.job'
        db.delete_column('zobpress_applicant', 'job_id')
