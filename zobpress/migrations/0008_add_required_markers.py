...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobFieldModel.required'
        db.add_column('zobpress_jobfieldmodel', 'required', orm['zobpress.jobfieldmodel:required'])
        
        # Deleting field 'Job.password'
        db.delete_column('zobpress_job', 'password')
        
        # Changing field 'JobType.slug'
        # (to signature: AutoSlugField(max_length=100, populate_from="name"))
        db.alter_column('zobpress_jobtype', 'slug', orm['zobpress.jobtype:slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'JobFieldModel.required'
        db.delete_column('zobpress_jobfieldmodel', 'required')
        
        # Adding field 'Job.password'
        db.add_column('zobpress_job', 'password', orm['zobpress.job:password'])
        
        # Changing field 'JobType.slug'
        # (to signature: AutoSlugField(max_length=100))
        db.alter_column('zobpress_jobtype', 'slug', orm['zobpress.jobtype:slug'])
