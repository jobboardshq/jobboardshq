...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BoardSettings'
        db.create_table('zobpress_boardsettings', (
            ('id', orm['zobpress.boardsettings:id']),
            ('analytics_code', orm['zobpress.boardsettings:analytics_code']),
            ('keywords', orm['zobpress.boardsettings:keywords']),
            ('tag_line', orm['zobpress.boardsettings:tag_line']),
            ('template', orm['zobpress.boardsettings:template']),
            ('board', orm['zobpress.boardsettings:board']),
        ))
        db.send_create_signal('zobpress', ['BoardSettings'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'BoardSettings'
        db.delete_table('zobpress_boardsettings')
    ...
    models = {
        ...
        'zobpress.jobtype': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_type': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'zobpress.page': {
