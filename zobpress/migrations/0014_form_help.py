...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobFieldModel.help_text'
        db.add_column('zobpress_jobfieldmodel', 'help_text', orm['zobpress.jobfieldmodel:help_text'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'JobFieldModel.help_text'
        db.delete_column('zobpress_jobfieldmodel', 'help_text')
    ...
    models = {
        ...
        'zobpress.page': {
            'Meta': {'unique_together': "(('job_board', 'page_slug'),)"},
