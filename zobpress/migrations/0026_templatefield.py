...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Board.template'
        db.add_column('zobpress_board', 'template', orm['zobpress.board:template'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Board.template'
        db.delete_column('zobpress_board', 'template')
    ...
    models = {
        ...
        'zobpress.board': {
            ...
            'template': ('django.db.models.fields.TextField', [], {'default': "'frontend/template1.css'", 'max_length': '128'})
        },
