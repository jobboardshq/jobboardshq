...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JobContactDetail'
        db.create_table('zobpress_jobcontactdetail', (
            ('id', orm['zobpress.jobcontactdetail:id']),
            ('name', orm['zobpress.jobcontactdetail:name']),
            ('email', orm['zobpress.jobcontactdetail:email']),
            ('website', orm['zobpress.jobcontactdetail:website']),
        ))
        db.send_create_signal('zobpress', ['JobContactDetail'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'JobContactDetail'
        db.delete_table('zobpress_jobcontactdetail')
