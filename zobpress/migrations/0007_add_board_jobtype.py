...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobType.name'
        db.add_column('zobpress_jobtype', 'name', orm['zobpress.jobtype:name'])
        
        # Adding field 'JobType.slug'
        db.add_column('zobpress_jobtype', 'slug', orm['zobpress.jobtype:slug'])
        
        # Adding field 'JobType.board'
        db.add_column('zobpress_jobtype', 'board', orm['zobpress.jobtype:board'])
        
        # Deleting field 'JobType.job_type'
        db.delete_column('zobpress_jobtype', 'job_type')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'JobType.name'
        db.delete_column('zobpress_jobtype', 'name')
        
        # Deleting field 'JobType.slug'
        db.delete_column('zobpress_jobtype', 'slug')
        
        # Deleting field 'JobType.board'
        db.delete_column('zobpress_jobtype', 'board_id')
        
        # Adding field 'JobType.job_type'
        db.add_column('zobpress_jobtype', 'job_type', orm['zobpress.jobtype:job_type'])
