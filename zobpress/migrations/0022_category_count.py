...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.category_count'
        db.add_column('zobpress_category', 'category_count', orm['zobpress.category:category_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Category.category_count'
        db.delete_column('zobpress_category', 'category_count')
