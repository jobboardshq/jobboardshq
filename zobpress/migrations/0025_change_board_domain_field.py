...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.SlugField(max_length=100, db_index=True))
        db.alter_column('zobpress_jobtype', 'slug', orm['zobpress.jobtype:slug'])
        
        # Changing field 'BoardSettings.logo'
        # (to signature: django.db.models.fields.files.ImageField(max_length=100, null=True, blank=True))
        db.alter_column('zobpress_boardsettings', 'logo', orm['zobpress.boardsettings:logo'])
