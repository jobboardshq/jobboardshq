...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeletedEntities'
        db.create_table('zobpress_deletedentities', (
            ('id', orm['zobpress.deletedentities:id']),
            ('board', orm['zobpress.deletedentities:board']),
            ('deleted_on', orm['zobpress.deletedentities:deleted_on']),
            ('object_id', orm['zobpress.deletedentities:object_id']),
            ('content_type', orm['zobpress.deletedentities:content_type']),
        ))
        db.send_create_signal('zobpress', ['DeletedEntities'])
        
        # Adding field 'Category.is_deleted'
        db.add_column('zobpress_category', 'is_deleted', orm['zobpress.category:is_deleted'])
        
        # Adding field 'JobType.is_deleted'
        db.add_column('zobpress_jobtype', 'is_deleted', orm['zobpress.jobtype:is_deleted'])
        
        # Adding field 'Job.is_deleted'
        db.add_column('zobpress_job', 'is_deleted', orm['zobpress.job:is_deleted'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'DeletedEntities'
        db.delete_table('zobpress_deletedentities')
        
        # Deleting field 'Category.is_deleted'
        db.delete_column('zobpress_category', 'is_deleted')
        
        # Deleting field 'JobType.is_deleted'
        db.delete_column('zobpress_jobtype', 'is_deleted')
        
        # Deleting field 'Job.is_deleted'
        db.delete_column('zobpress_job', 'is_deleted')
    ...
    models = {
        ...
        'zobpress.job': {
            ...
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
