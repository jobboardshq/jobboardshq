...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.CharField(max_length=300, null=True, blank=True))
        db.alter_column('zobpress_job', 'name', orm['zobpress.job:name'])
        
        # Creating unique_together for [board, name, is_deleted] on Category.
        db.create_unique('zobpress_category', ['board_id', 'name', 'is_deleted'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [board, name, is_deleted] on Category.
        db.delete_unique('zobpress_category', ['board_id', 'name', 'is_deleted'])
