...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Board.introductory_text'
        db.add_column('zobpress_board', 'introductory_text', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Changing field 'JobType.slug'
        db.alter_column('zobpress_jobtype', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=100, populate_from=None))


    def backwards(self, orm):
        
        # Deleting field 'Board.introductory_text'
        db.delete_column('zobpress_board', 'introductory_text')

        # Changing field 'JobType.slug'
        db.alter_column('zobpress_jobtype', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))
    ...
    models = {
        ...
        'zobpress.board': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introductory_text': ('django.db.models.fields.TextField', [], {'default': "''"}),
