...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.times_viewed'
        db.add_column('zobpress_job', 'times_viewed', orm['zobpress.job:times_viewed'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Job.times_viewed'
        db.delete_column('zobpress_job', 'times_viewed')
