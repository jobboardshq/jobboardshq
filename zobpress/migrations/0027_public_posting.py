...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BoardSettings.allow_public_posting'
        db.add_column('zobpress_boardsettings', 'allow_public_posting', orm['zobpress.boardsettings:allow_public_posting'])
        if not db.dry_run:
            orm.BoardSettings.objects.all().update(allow_public_posting = True)


    def backwards(self, orm):

        # Deleting field 'BoardSettings.allow_public_posting'
        db.delete_column('zobpress_boardsettings', 'allow_public_posting')
    ...
    models = {
        ...
        'zobpress.boardsettings': {
            'allow_public_posting': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
