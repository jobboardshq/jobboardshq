...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('zobpress_applicant', (
            ('id', orm['zobpress.applicant:id']),
            ('board', orm['zobpress.applicant:board']),
            ('name', orm['zobpress.applicant:name']),
            ('response', orm['zobpress.applicant:response']),
            ('resume', orm['zobpress.applicant:resume']),
        ))
        db.send_create_signal('zobpress', ['Applicant'])
        
        # Changing field 'Job.category'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['zobpress.Category']))
        db.alter_column('zobpress_job', 'category_id', orm['zobpress.job:category'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zobpress_applicant')
        
        # Changing field 'Job.category'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['zobpress.Category'], null=True, blank=True))
        db.alter_column('zobpress_job', 'category_id', orm['zobpress.job:category'])
