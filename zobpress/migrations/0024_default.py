...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.is_default'
        db.add_column('zobpress_job', 'is_default', orm['zobpress.job:is_default'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Job.is_default'
        db.delete_column('zobpress_job', 'is_default')
