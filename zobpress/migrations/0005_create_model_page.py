...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Page'
        db.create_table('zobpress_page', (
            ('id', orm['zobpress.page:id']),
            ('title', orm['zobpress.page:title']),
            ('page_slug', orm['zobpress.page:page_slug']),
            ('content', orm['zobpress.page:content']),
            ('job_board', orm['zobpress.page:job_board']),
        ))
        db.send_create_signal('zobpress', ['Page'])
