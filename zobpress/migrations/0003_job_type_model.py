...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('zobpress_jobtype', (
            ('id', orm['zobpress.jobtype:id']),
            ('job_type', orm['zobpress.jobtype:job_type']),
        ))
        db.send_create_signal('zobpress', ['JobType'])
        
        # Adding field 'Job.job_type'
        db.add_column('zobpress_job', 'job_type', orm['zobpress.job:job_type'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zobpress_jobtype')
        
        # Deleting field 'Job.job_type'
        db.delete_column('zobpress_job', 'job_type_id')
